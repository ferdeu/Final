...
class ProductsController extends Controller
{
    ...
    public function update(Request $request, $id) {
		...
		if ($request->file('fotoPathNueva')){
    	$extensionImagen = $request->file('fotoPathNueva')->getClientOriginalExtension();
    	$fotoPathNuevo = $request->file('fotoPathNueva')->storeAs('productos', uniqid() . "." . $extensionImagen, 'public');
		$product->fotopath = $fotoPathNuevo;
		}
